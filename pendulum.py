...
class model: 
    ...
    def __init__(self): 
        ...
        self.N_z = 2 
        self.N_store = 100000 
        self.params_list = ['G', 'M', 'L'] 
        self.params_values_list  = [9.8, 1, 1] 
        self.inputs_ini_list = ['u', 'u_dummy'] 
        self.inputs_ini_values_list  = [0.0, 1.0] 
        self.inputs_run_list = ['u', 'u_dummy'] 
        self.inputs_run_values_list = [0.0, 1.0] 
        self.outputs_list = ['x_pos', 'y_pos'] 
        ...
        self.sp_jac_ini = sspa.load_npz('./__pycache__/pendulum_sp_jac_ini_num.npz')
        ...
        self.sp_jac_run = sspa.load_npz('./__pycache__/pendulum_sp_jac_run_num.npz')
        ...
        self.sp_jac_trap = sspa.load_npz('./__pycache__/pendulum_sp_jac_trap_num.npz')
        ...
        #self.sp_Fu_run = sspa.load_npz('./__pycache__/pendulum_Fu_run_num.npz')
        #self.sp_Gu_run = sspa.load_npz('./__pycache__/pendulum_Gu_run_num.npz')
        #self.sp_Hx_run = sspa.load_npz('./__pycache__/pendulum_Hx_run_num.npz')
        #self.sp_Hy_run = sspa.load_npz('./__pycache__/pendulum_Hy_run_num.npz')
        #self.sp_Hu_run = sspa.load_npz('./__pycache__/pendulum_Hu_run_num.npz')        
...
def sp_jac_trap_vectors():
    ...
    sp_jac_trap_ia = [0, 1, 0, 1, 2]
    sp_jac_trap_ja = [0, 2, 4, 5]
    sp_jac_trap_nia = 3
    sp_jac_trap_nja = 3
